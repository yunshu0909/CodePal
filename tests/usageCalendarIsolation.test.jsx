...
describe('usage calendar isolation',()=>{
 it('TC030: PageShell retains its existing markup and default class',()=>{const {container}=render(<PageShell title="对话回顾" subtitle="旧页面">原内容</PageShell>);expect(container.firstChild.className).toBe('page-shell');expect(screen.getByRole('heading',{name:'对话回顾'})).toHaveClass('page-shell__title');cleanup()})
